 ...
 * Deployed to Testnet: November 15, 2024
 */
export const CONTRACT_IDS = {
  tokenFactory: process.env.NEXT_PUBLIC_TOKEN_FACTORY_CONTRACT_ID || '',
  ammPair: process.env.NEXT_PUBLIC_AMM_PAIR_CONTRACT_ID || '',
